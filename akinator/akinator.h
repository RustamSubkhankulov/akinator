...
#define tree_read_from_file(tree, filename) \
       _tree_read_from_file(tree, filename, LOG_ARGS)

#define node_read_from_buffer(node, buffer_struct) \
       _node_read_from_buffer(node, buffer_struct, LOG_ARGS)


#define akinator_init_base(tree, filename) \
       _akinator_init_base(tree, filename, LOG_ARGS)
